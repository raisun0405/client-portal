...
// Current rule: only payment-confirmed features count toward money totals.
// (Unconfirmed "rate pending" features are stored with amount 0 anyway, so this
// filter is also a safety net rather than the sole guard.)
